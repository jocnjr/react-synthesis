...
const CommentData = require('./comments/plugin.synth');

module.exports = { Collection, CollectionData, PostManager, PostManagerData, PostFeed, PostFeedData, Comment, CommentData }
